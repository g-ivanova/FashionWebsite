<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shirt4.aspx.cs" Inherits="items_shirts_shirt4" %>
...
<head runat="server">
    ...
    <title>Тениска с паднали рамене</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function setOpacity2() {
            ...
            document.getElementById("colorName").innerText = "Маслина";
        }
        ...
        function setOpacity4() {
            ...
            document.getElementById("green").style.opacity = 0.5;
            document.getElementById("black").style.opacity = 0.5;
            document.getElementById("colorName").innerText = "Лимоненожълто";
        }
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/shirts/shirt4/shirt4_pink1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/shirts/shirt4/shirt4_pink1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/shirts/shirt4/shirt4_pink2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/shirts/shirt4/shirt4_pink3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/shirts/shirt4/shirt4_pink4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/shirts/shirt4/shirt4_pink5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Тениска с паднали рамене</h1>  <br />
			    <h4 style="display:inline-block">29,99 лв.</h4>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Антично Розово</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="pink" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="pink" src="/images/shirts/shirt4/shirt4_pink1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="green" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="green" src="/images/shirts/shirt4/shirt4_green1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="black" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity3()" id="black" src="/images/shirts/shirt4/shirt4_black1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="yellow" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity4()" id="yellow" src="/images/shirts/shirt4/shirt4_yellow1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4"  style="width:50% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Голо/Паднало рамо
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Жарсе
                    </span>
                </div>
                <div class="col-4" style="width:50% !important; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>С паднали рамене
                    </span>
                </div>
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Структурирана дръжка
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Мека дръжка
                    </span>
                </div>
            </div>
            ...
            <span>Къс ръкав</span> <br />
            <span>Нормална дължина</span> <br />
            <span>Тясна форма</span> <br /><br />

            <h6 style="font-weight:bold">Състав</h6>
            <span>97% памук</span> <br />
