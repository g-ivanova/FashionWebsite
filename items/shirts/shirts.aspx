<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shirts.aspx.cs" Inherits="items_shirts_shirts" %>
                ...
                <div class="container">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        ...
                        <div class="col">    
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/shirts/shirt3.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            ...
                                            <img src="/images/shirts/shirt3/shirt3_black1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/jeans/jeans2.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Тениска с коледен мотив</h6> 
                                        <span class="newPrice">48,99 лв.</span>
                                    </div>
                                </a>
                            </div> 
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/shirts/shirt4.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <img src="/images/shirts/shirt4/shirt4_pink1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/shirts/shirt4.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Тениска с паднали рамене</h6> 
                                        <span class="newPrice">29,99 лв.</span>
                                    </div>
                                </a>
                            </div>
                        </div>
