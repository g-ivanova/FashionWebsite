<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shirt3.aspx.cs" Inherits="items_shirts_shirt3" %>
...
<head runat="server">
    ...
    <title>Тениска с коледен мотив</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/shirts/shirt3/shirt3_black1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/shirts/shirt3/shirt3_black1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/shirts/shirt3/shirt3_black2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/shirts/shirt3/shirt3_black3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/shirts/shirt3/shirt3_black4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/shirts/shirt3/shirt3_black5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Тениска с коледен мотив</h1> <br />
			    <h4 style="display:inline-block">48,99 лв.</h4>
                <br />
                ...
                <div id="slide-colors" >
                    ...
                    <label>
                        ...
                        <img class="thumbnail" onmouseover="setOpacity1()" id="black" src="/images/shirts/shirt3/shirt3_black1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                     <label>
                        <input type="radio" name="colorRadio" value="grey" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="grey" src="/images/shirts/shirt3/shirt3_grey1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Надписи
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Коледен мотив
                    </span>
                </div>
            </div>
