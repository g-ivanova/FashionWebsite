<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shirt2.aspx.cs" Inherits="items_shirts_shirt2" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/shirts/shirt2/shirt2_white1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/shirts/shirt2/shirt2_white1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/shirts/shirt2/shirt2_white2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/shirts/shirt2/shirt2_white3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/shirts/shirt2/shirt2_white4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/shirts/shirt2/shirt2_white5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Тениска на райета</h1> <br />
                <div style="background-color:#cc0000; width:70px; color:white; font-weight:bold; text-align:center">-30%</div>
			    <h4 style="display:inline-block; color:#cc0000">59,99 лв.</h4>
                <del class="oldPrice" style="color:dimgrey">41,99 лв.</del>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Бяло</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="white" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="white" src="/images/shirts/shirt2/shirt2_white1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Райета
                    </span>
                </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%;padding-bottom:1%">
                 ...
                 <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Обточено с кант деколте
                    </span>
                </div>
            </div>
        ...
        <div class="row justify-content-between">
                <div class="col-4" style="width:53%;padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Цялостен десен
                    </span>
                </div>            
                 <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
