<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jacket5.aspx.cs" Inherits="items_jackets_jacket5" %>
...
<head runat="server">
    ...
    <title>Преходно байкър яке</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        function setOpacity1() {
            ...
            document.getElementById("colorName").innerText = "Светлолилаво";
        }
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/jackets/jacket5/jacket5_purple1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/jackets/jacket5/jacket5_purple1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/jackets/jacket5/jacket5_purple2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/jackets/jacket5/jacket5_purple3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/jackets/jacket5/jacket5_purple4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/jackets/jacket5/jacket5_purple5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Преходно байкър яке</h1>
			    <div style="background-color:#e6e6e6; text-align: center; border:1px solid; border-color: #d9d9d9; width:80px; color:black;">Ново</div>
                <br />
			    <h4 style="display:inline-block">81,99 лв.</h4>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Светлолилаво</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="purple" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="purple" src="/images/jackets/jacket5/jacket5_purple1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4"  style="width:51% !important; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Кожа
                    </span>
                </div>
                <div class="col-4" style="width:51% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Диагонален цип
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Байкър яке
                    </span>
                </div>
                <div class="col-4" style="width:51% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Регулируема каишка
                    </span>
                </div>
            </div>

            <div class="row justify-content-between">
                <div class="col-4" style="width:49%; padding-bottom:1%" >
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Цип на ръкавите
                    </span>
                </div>
                <div class="col-4" style="width:51% !important; padding-bottom:1%">
                    <span>
            ...
            <span>80% кожа</span> <br />
            <span>20% полиестер</span><br />
