<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jacket7.aspx.cs" Inherits="items_jackets_jacket7" %>
...
<head runat="server">
    ...
    <title>Изчистено бомбър яке</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function setOpacity2() {
            ...
            document.getElementById("colorName").innerText = "Бежово";
        }
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/jackets/jacket7/jacket7_green1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/jackets/jacket7/jacket7_green1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/jackets/jacket7/jacket7_green2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/jackets/jacket7/jacket7_green3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/jackets/jacket7/jacket7_green4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/jackets/jacket7/jacket7_green5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
                ...
                <div id="slide-colors" >
                    ...
                    <h6 style="display:inline-block" id="colorName">Маслина</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="green" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="green" src="/images/jackets/jacket7/jacket7_green1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="white" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="white" src="/images/jackets/jacket7/jacket7_white1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Паднали рамене
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Яке тип бомбър
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Яка от ластична плетка
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
