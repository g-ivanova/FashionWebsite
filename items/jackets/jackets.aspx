<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jackets.aspx.cs" Inherits="jackets" %>
                ...
                <div class="container">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        ...
                        <div class="col">    
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/jackets/jacket3.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            ...
                                            <img src="/images/jackets/jacket3/jacket3_red1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/jackets/jacket3.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Зимно яке с изчистен дизайн</h6> 
                        ...
                        <div class="col-sm-4">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/jackets/jacket4.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <img src="/images/jackets/jacket4/jacket4_pink1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/jackets/jacket4.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Преходно яке в два цвята</h6> 
                                        <span class="newPrice">107,99 лв.</span>
                                    </div>
                                </a>
                            </div> 
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4" style="padding-top: 2%">
                        ...
                        <div class="col-sm-4">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/jackets/jacket7.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <img src="/images/jackets/jacket7/jacket7_green1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/jackets/jacket7.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Изчистено бомбър яке</h6> 
