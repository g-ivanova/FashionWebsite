<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jacket3.aspx.cs" Inherits="items_jackets_jacket3" %>
...
<head runat="server">
    ...
    <title>Зимно яке с изчистен дизайн</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        function setOpacity1() {
            ...
            document.getElementById("colorName").innerText = "Червено";
        }
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/jackets/jacket3/jacket3_red1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/jackets/jacket3/jacket3_red1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/jackets/jacket3/jacket3_red2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/jackets/jacket3/jacket3_red3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/jackets/jacket3/jacket3_red4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/jackets/jacket3/jacket3_red5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Зимно яке с изчистен дизайн</h1><br />
			    <h4 style="display:inline-block">131,99 лв.</h4>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Червено</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="red" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="red" src="/images/jackets/jacket3/jacket3_red1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="black" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="black" src="/images/jackets/jacket3/jacket3_black1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
                ...
                <div style="background-color:#ffe680; width:40%; height:4%; text-align:center;">
                    <span style="font-size:11px; color:black;">Налични са само няколко бройки!</span>
                </div>
		    </div>
        </div>
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4"  style="width:57% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Странични джобове с цип
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:43%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Секретни копчета
                    </span>
                </div>
                <div class="col-4" style="width:57% !important; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%" >
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Трико рипс
                    </span>
                </div>
                <div class="col-4" style="width:57% !important; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%" >
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Изправена яка
                    </span>
                </div>
                <div class="col-4" style="width:57% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>С топла подплата
                    </span>
                </div>
            </div>
            ...
            <span>30°C лесно за поддръжка</span><br />
