<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jacket8.aspx.cs" Inherits="items_jackets_jacket8" %>
...
<body>
    ...
    <script type="text/javascript">
        function setOpacity1() {
            ...
            document.getElementById("pink").style.opacity = 0.5;
            document.getElementById("red").style.opacity = 0.5;
            document.getElementById("black").style.opacity = 0.5;
            document.getElementById("colorName").innerText = "Жълто";
        }
        function setOpacity2() {
            ...
            document.getElementById("colorName").innerText = "Антично розово";
        }
        function setOpacity3() {
            ...
            document.getElementById("yellow").style.opacity = 0.5; 
            document.getElementById("pink").style.opacity = 0.5;      
            document.getElementById("colorName").innerText = "Светлочервено";
        }
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/jackets/jacket8/jacket8_yellow1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/jackets/jacket8/jacket8_yellow1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/jackets/jacket8/jacket8_yellow2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/jackets/jacket8/jacket8_yellow3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/jackets/jacket8/jacket8_yellow4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/jackets/jacket8/jacket8_yellow5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Есенно топло яке</h1> <br />
                <div style="background-color:#cc0000; width:70px; color:white; font-weight:bold; text-align:center">-39%</div>
			    <h4 style="display:inline-block; color:#cc0000">150,99 лв.</h4>
                ...
                <div id="slide-colors" >
                    ...
                    <h6 style="display:inline-block" id="colorName">Жълто</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="yellow" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="yellow" src="/images/jackets/jacket8/jacket8_yellow1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="pink" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="pink" src="/images/jackets/jacket8/jacket8_pink1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="red" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity3()" id="red" src="/images/jackets/jacket8/jacket8_red1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="black" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity4()" id="black" src="/images/jackets/jacket8/jacket8_black1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Странични джобове
                    </span>
                </div>
            </div>

            <div class="row justify-content-between">
                <div class="col-4" style="width:47%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Ватирано яке
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Ватирана материя
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Едноцветни тегели
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:47%; padding-bottom:1%" >
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Качулка с връзки
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Вталена кройка
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:47%; padding-bottom:1%" >
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Ластичен подгъв
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Гладка материя
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%" >
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Прав подгъв
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Без подплата
                    </span>
                </div>
            </div>
            ...
            <span>Нормална кройка</span> <br /><br />

            <h6 style="font-weight:bold">Състав</h6>
            <span>70% полиестер</span> <br />
            <span>30% найлон</span> <br />
            <span>Нееластичен</span> <br /><br />

            <h6 style="font-weight:bold">Поддръжка</h6>
            <span>Пране на 30°C</span> <br />
            <span>Без химическо чистене</span> <br />
            <span>Да не се глади на висока температура</span><br />
            <span>Да не се използва белина</span><br />
            <span>Сушене на ниска температура</span><br />
