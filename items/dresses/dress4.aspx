<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dress4.aspx.cs" Inherits="items_dresses_dress4" %>
...
<head runat="server">
    ...
    <title>Коктейлна рокля с пайети</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function setOpacity2() {
            ...
            document.getElementById("colorName").innerText = "Мента";
        }   
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/dresses/dress4/dress4_white1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/dresses/dress4/dress4_white1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/dresses/dress4/dress4_white2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/dresses/dress4/dress4_white3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/dresses/dress4/dress4_white4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/dresses/dress4/dress4_white5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Коктейлна рокля с пайети</h1> <br />
                ...
                <div id="slide-colors" >
                    ...
                    <label>
                        ...
                        <img class="thumbnail" onmouseover="setOpacity1()" id="white" src="/images/dresses/dress4/dress4_white1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="green" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="green" src="/images/dresses/dress4/dress4_green1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <span>94% полиестер</span> <br />
            <span>6% еластан</span> <br /><br />
