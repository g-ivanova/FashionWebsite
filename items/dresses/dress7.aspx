<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dress7.aspx.cs" Inherits="items_dresses_dress7" %>
...
<head runat="server">
    ...
    <title>Изящна вечерна рокля</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        function setOpacity1() {
            ...
            document.getElementById("colorName").innerText = "Кремаво";
        }   
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/dresses/dress7/dress7_white1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/dresses/dress7/dress7_white1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/dresses/dress7/dress7_white2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/dresses/dress7/dress7_white3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/dresses/dress7/dress7_white4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/dresses/dress7/dress7_white5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Изящна вечерна рокля</h1>  <br />
			    <h4 style="display:inline-block">188,99 лв.</h4>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Кремаво</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="white" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="white" src="/images/dresses/dress7/dress7_white1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Изрязан гръб
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Волан
                    </span>
                </div>
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
             ...
             <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:50%; padding-bottom:1%">
                   <span>
                       <i class="fa fa-check-square" style="padding-right:3%"></i>Обемна материя
                   </span>
                </div>
            </div>
            ...
            <span>Нормална форма</span> <br /><br />
