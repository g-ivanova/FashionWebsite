<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dress3.aspx.cs" Inherits="items_dresses_dress3" %>
...
<head runat="server">
    ...
    <title>Елегантна вечерна рокля</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        function setOpacity1() {
            ...
            document.getElementById("white").style.opacity = 0.5;
            document.getElementById("colorName").innerText = "Смарагдово Зелено";
        }
        function setOpacity2() {
            ...
            document.getElementById("colorName").innerText = "Бледорозово";
        }
        function setOpacity3() {
            ...
            document.getElementById("green").style.opacity = 0.5;
            document.getElementById("pink").style.opacity = 0.5;
            document.getElementById("colorName").innerText = "Бургундово Червено";
        }
        function setOpacity4() {
            ...
            document.getElementById("pink").style.opacity = 0.5;
            document.getElementById("red").style.opacity = 0.5;
            document.getElementById("colorName").innerText = "Нейви Синьо";
        }
        function setOpacity5() {
            ...
            document.getElementById("red").style.opacity = 0.5;
            document.getElementById("blue").style.opacity = 0.5;
            document.getElementById("colorName").innerText = "Бяло";
        }
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/dresses/dress3/dress3_green1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/dresses/dress3/dress3_green1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/dresses/dress3/dress3_green2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/dresses/dress3/dress3_green3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/dresses/dress3/dress3_green4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/dresses/dress3/dress3_green5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Елегантна вечерна рокля</h1>
                <div style="background-color:#e6e6e6; text-align: center; border:1px solid; border-color: #d9d9d9; width:80px; color:black;">Ново</div>
                <br />
			    <h4 style="display:inline-block">125,99 лв.</h4>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Смарагдово Зелено</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="green" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="green" src="/images/dresses/dress3/dress3_green1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="pink" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="pink" src="/images/dresses/dress3/dress3_pink1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="red" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity3()" id="red" src="/images/dresses/dress3/dress3_red1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="blue" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity4()" id="blue" src="/images/dresses/dress3/dress3_blue1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="white" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity5()" id="white" src="/images/dresses/dress3/dress3_white1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width: 53%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Широка презрамка
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Цип на гърба
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>V-образно деколте
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Плисе
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Леко падаща материя
                    </span>
                </div>
            </div>
            ...
            <span>Без ръкави</span> <br />
            <span>7/8 дължина</span> <br />
