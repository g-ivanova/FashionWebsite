<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dresses.aspx.cs" Inherits="items_dresses_dresses" %>
                ...
                <div class="container">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        ...
                        <div class="col">    
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/dresses/dress2.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <img src="/images/dresses/dress2/dress2_blue1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/dresses/dress2.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Вечерна рокля с пайети</h6> 
                                        <span class="newPrice">191,99 лв.</span>
                                    </div>
                                </a>
                            </div> 
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4" style="padding-top: 2%">
                        ...
                        <div class="col">    
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/dresses/dress5.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            ...
                                            <img src="/images/dresses/dress5/dress5_blue1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/dresses/dress5.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Официална вечерна рокля</h6> 
                                        <span class="newPrice">123,99 лв.</span>
                                    </div>
                                </a>
                            </div> 
                        </div>
                        ...
                        <div class="col">    
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/dresses/dress7.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <img src="/images/dresses/dress7/dress7_white1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/dresses/dress7.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Изящна вечерна рокля</h6> 
                                        <span class="newPrice">188,99 лв.</span>
                                    </div>
                                </a>
                            </div> 
                        </div>
