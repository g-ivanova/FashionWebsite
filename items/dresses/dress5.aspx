<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dress5.aspx.cs" Inherits="items_dresses_dress5" %>
...
<head runat="server">
    ...
    <title>Официална вечерна рокля</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/dresses/dress5/dress5_blue1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/dresses/dress5/dress5_blue1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/dresses/dress5/dress5_blue2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/dresses/dress5/dress5_blue3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/dresses/dress5/dress5_blue4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/dresses/dress5/dress5_blue5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Официална вечерна рокля</h1> <br />
			    <h4 style="display:inline-block">123,99 лв.</h4>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Синьо</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="blue" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="blue" src="/images/dresses/dress5/dress5_blue1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Леко прозрачен
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Регулиращи се дръжки
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Колан на талията
                    </span>
                </div>
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Полуревер
                    </span>
                </div>
            </div>
