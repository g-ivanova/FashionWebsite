<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jeans4.aspx.cs" Inherits="items_jeans_jeans4" %>
...
<head runat="server">
    ...
    <title>Накъсани дънки с бродерия</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/jeans/jeans4/jeans4_blue1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/jeans/jeans4/jeans4_blue1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/jeans/jeans4/jeans4_blue2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/jeans/jeans4/jeans4_blue3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/jeans/jeans4/jeans4_blue4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/jeans/jeans4/jeans4_blue5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Накъсани дънки с бродерия</h1> <br />
                <div style="background-color:#cc0000; width:70px; color:white; font-weight:bold; text-align:center">-15%</div>
			    <h4 style="display:inline-block; color:#cc0000">99,99 лв.</h4>
                <del class="oldPrice" style="color:dimgrey">84,99 лв.</del>
                <br />
                ...
                <div id="slide-colors" >
                    ...
                    <label>
                        ...
                        <img class="thumbnail" onmouseover="setOpacity1()" id="blue" src="/images/jeans/jeans4/jeans4_blue1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%;padding-bottom:1%">
                 ...
                 <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Накъсани
                    </span>
                </div>
            </div>
        ...
        <div class="row justify-content-between">
            ...
            <span>79% памук</span> <br />
            <span>20% лиосел</span> <br />
            <span>1% еластан</span> <br /><br />
