<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jeans5.aspx.cs" Inherits="items_jeans_jeans5" %>
...
<head runat="server">
    ...
    <title>Skinny дънки 'Replay'</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function setOpacity2() {
            ...
            document.getElementById("colorName").innerText = "Естествено Бяло";
        } 
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/jeans/jeans5/jeans5_pink1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/jeans/jeans5/jeans5_pink1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/jeans/jeans5/jeans5_pink2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/jeans/jeans5/jeans5_pink3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/jeans/jeans5/jeans5_pink4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/jeans/jeans5/jeans5_pink5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Skinny дънки 'Replay'</h1> <br />
                <div style="background-color:#cc0000; width:70px; color:white; font-weight:bold; text-align:center">-13%</div>
			    <h4 style="display:inline-block; color:#cc0000">115,99 лв.</h4>
                ...
                <div id="slide-colors" >
                    ...
                    <label>
                        ...
                        <img class="thumbnail" onmouseover="setOpacity1()" id="pink" src="/images/jeans/jeans5/jeans5_pink1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="white" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="white" src="/images/jeans/jeans5/jeans5_white1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%;padding-bottom:1%">
                 ...
                 <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Цветен деним
                    </span>
                </div>
            </div>
        ...
        <div class="row justify-content-between">
            ...
            <span>Със средна талия</span> <br /><br />

            <h6 style="font-weight:bold">Състав</h6>
            <span>88% памук</span> <br />
            <span>7% полиестер</span> <br />
