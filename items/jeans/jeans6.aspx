<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jeans6.aspx.cs" Inherits="items_jeans_jeans6" %>
...
<head runat="server">
    ...
    <title>Дънки 'KELLY' в Сиво</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/jeans/jeans6/jeans6_grey1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/jeans/jeans6/jeans6_grey1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/jeans/jeans6/jeans6_grey2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/jeans/jeans6/jeans6_grey3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/jeans/jeans6/jeans6_grey4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/jeans/jeans6/jeans6_grey5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Дънки 'KELLY' в Сиво</h1>  <br />
			    <h4 style="display:inline-block">121,99 лв.</h4>
                <br />
                ...
                <div id="slide-colors" >
                    ...
                    <label>
                        ...
                        <img class="thumbnail" onmouseover="setOpacity1()" id="grey" src="/images/jeans/jeans6/jeans6_grey1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:50% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Acid washed
                    </span>
                </div>
            </div>
