<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coat2.aspx.cs" Inherits="items_coats_coat2" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function setOpacity2() {
            ...
            document.getElementById("colorName").innerText = "Тъмночервено";
        }        
        function setOpacity3() {
            document.getElementById("beige").style.opacity = 1;
            document.getElementById("black").style.opacity = 0.5;
            document.getElementById("red").style.opacity = 0.5;
            document.getElementById("colorName").innerText = "Камел";
        }
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/coats/coat2/coat2_black1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/coats/coat2/coat2_black1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/coats/coat2/coat2_black2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/coats/coat2/coat2_black3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/coats/coat2/coat2_black4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/coats/coat2/coat2_black5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Класическо палто</h1> <br />
                <div style="background-color:#cc0000; width:70px; color:white; font-weight:bold; text-align:center">-25%</div>
			    <h4 style="display:inline-block; color:#cc0000">110,99 лв.</h4>
                ...
                <div id="slide-colors" >
                    ...
                    <h6 style="display:inline-block" id="colorName">Черно</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="black" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="black" src="/images/coats/coat2/coat2_black1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="red" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="red" src="/images/coats/coat2/coat2_red1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="beige" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity3()" id="beige" src="/images/coats/coat2/coat2_beige1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Тежък плат
                    </span>
                </div>
            </div>
