<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coat7.aspx.cs" Inherits="items_coats_coat7" %>
...
<head runat="server">
    ...
    <title>Дълго вълнено палто</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        function setOpacity1() {
            ...
            document.getElementById("colorName").innerText = "Неоново Червено";
        }
        function setOpacity2() {
            document.getElementById("beige").style.opacity = 1;
            document.getElementById("black").style.opacity = 0.5;
            document.getElementById("red").style.opacity = 0.5;
            document.getElementById("colorName").innerText = "Светлокафяво";
        }        
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/coats/coat7/coat7_red1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/coats/coat7/coat7_red1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/coats/coat7/coat7_red2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/coats/coat7/coat7_red3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/coats/coat7/coat7_red4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/coats/coat7/coat7_red5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Дълго вълнено палто</h1>
                <div style="background-color:#e6e6e6; text-align: center; border:1px solid; border-color: #d9d9d9; width:80px; color:black;">Ново</div>
                <br />
			    <h4 style="display:inline-block">166,99 лв.</h4>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Неоново червено</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="red" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="red" src="/images/coats/coat7/coat7_red1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="beige" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="beige" src="/images/coats/coat7/coat7_beige1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="black" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity3()" id="black" src="/images/coats/coat7/coat7_black1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4"  style="width:50% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Колан
                    </span>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Вълна
                    </span>
                </div>
                <div class="col-4" style="width:50% !important; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Яка с ревери
                    </span>
                </div>
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:50%; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Странични цепки
                    </span>
                </div>
            </div>
            ...
            <span>100% вълна</span> <br />
            <span>Съдържа нетекстилни части от животински произход</span> <br /><br />
