<%@ Page Language="C#" AutoEventWireup="true" CodeFile="promotions.aspx.cs" Inherits="items_promotions_promotions" %>
                ...
                <div class="container">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/jackets/jacket1.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <div class="discount" style="position:absolute; top: 20px; background-color:#cc0000; width:70px; color:white; font-weight:bold">- 40%</div>
                                            <img src="/images/jackets/jacket1/jacket1_red1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                ...
                                <a class="productInfo" href="/items/jackets/jacket1.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Зимно яке с пухена подплата</h6> 
                                        <span class="newPrice" style="color:#cc0000">92,99 лв.</span>
                                        <del class="oldPrice" style="color:dimgrey">154,99 лв.</del>
                                    </div>
                                </a>
                            </div>             
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/jackets/jacket2.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <div class="discount" style="position:absolute; top: 20px; background-color:#cc0000; width:70px; color:white; font-weight:bold">-24%</div>
                                            <img src="/images/jackets/jacket2/jacket2_blue1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/jackets/jacket2.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Преходно яке с висока яка</h6> 
                                        <span class="newPrice" style="color:#cc0000">88,99 лв.</span>
                                        <del class="oldPrice" style="color:dimgrey">116,99 лв.</del>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/jackets/jacket8.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <div class="discount" style="position:absolute; top: 20px; background-color:#cc0000; width:70px; color:white; font-weight:bold">- 39%</div>
                                            <img src="/images/jackets/jacket8/jacket8_yellow1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/jackets/jacket8.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Есенно топло яке</h6> 
                                        <span class="newPrice" style="color:#cc0000">150,99 лв.</span>
                                        <del class="oldPrice" style="color:dimgrey">189,99 лв.</del>
                                    </div>
                                </a>
                            </div>             
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4" style="padding-top: 2%">
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/dresses/dress4.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <div class="discount" style="position:absolute; top: 20px; background-color:#cc0000; width:70px; color:white; font-weight:bold">-17%</div>
                                            <img src="/images/dresses/dress4/dress4_white1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/dresses/dress4.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Коктейлна рокля с пайети</h6> 
                                        <span class="newPrice" style="color:#cc0000">92,99 лв.</span>
                                        <del class="oldPrice" style="color:dimgrey">111,99 лв.</del>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/dresses/dress6.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <div class="discount" style="position:absolute; top: 20px; background-color:#cc0000; width:70px; color:white; font-weight:bold">-34%</div>
                                            <img src="/images/dresses/dress6/dress6_grey1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/dresses/dress6.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Стилна коктейлна рокля</h6> 
                                        <span class="newPrice" style="color:#cc0000">108,99 лв.</span>
                                        <del class="oldPrice" style="color:dimgrey">164,99 лв.</del>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/shirts/shirt2.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <div class="discount" style="position:absolute; top: 20px; background-color:#cc0000; width:70px; color:white; font-weight:bold">-30%</div>
                                            <img src="/images/shirts/shirt2/shirt2_white1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/shirts/shirt2.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Тениска на райета</h6> 
                                        <span class="newPrice" style="color:#cc0000">41,99 лв.</span>
                                        <del class="oldPrice" style="color:dimgrey">59,99 лв.</del>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/blouses/blouse4.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <div class="discount" style="position:absolute; top: 20px; background-color:#cc0000; width:70px; color:white; font-weight:bold">-17%</div>
                                            <img src="/images/blouses/blouse4/blouse4_red1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/blouses/blouse4.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Блуза с дълбоко деколте</h6> 
                                        <span class="newPrice" style="color:#cc0000">73,99 лв.</span>
                                        <del class="oldPrice" style="color:dimgrey">88,99 лв.</del>
                                    </div>
                                </a>
                            </div>
                        </div>
