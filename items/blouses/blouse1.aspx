<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blouse1.aspx.cs" Inherits="items_blouses_blouse1" %>
...
<head runat="server">
    ...
    <title>Блуза със свободна кройка</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/blouses/blouse1/blouse1_pink1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/blouses/blouse1/blouse1_pink1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/blouses/blouse1/blouse1_pink2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/blouses/blouse1/blouse1_pink3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/blouses/blouse1/blouse1_pink4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/blouses/blouse1/blouse1_pink5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Блуза със свободна кройка</h1>
                ...
                <div id="slide-colors" >
                    ...
                    <h6 style="display:inline-block" id="colorName">Бледорозово</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="pink" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="pink" src="/images/blouses/blouse1/blouse1_pink1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
                    <label>
                        <input type="radio" name="colorRadio" value="black" style="position: absolute; opacity:0; width:0; height:0"/>
                        <img class="thumbnail" onmouseover="setOpacity2()" id="black" src="/images/blouses/blouse1/blouse1_black1.jpg" style ="width:80px; height:100px; opacity:0.5; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Широка блуза
                    </span>
                </div>
            </div>
            ...
            <span>Неподходящ за съшилня</span> <br />
