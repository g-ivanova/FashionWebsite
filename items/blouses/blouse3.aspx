<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blouse3.aspx.cs" Inherits="items_blouses_blouse3" %>
...
<head runat="server">
    ...
    <title>Блуза с широки ръкави</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        function setOpacity1() {
            ...
            document.getElementById("colorName").innerText = "Злато";
        }
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/blouses/blouse3/blouse3_beige1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/blouses/blouse3/blouse3_beige1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/blouses/blouse3/blouse3_beige2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/blouses/blouse3/blouse3_beige3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/blouses/blouse3/blouse3_beige4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/blouses/blouse3/blouse3_beige5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Блуза с широки ръкави</h1> <br />
			    <h4 style="display:inline-block">67,99 лв.</h4>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Злато</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="beige" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="beige" src="/images/blouses/blouse3/blouse3_beige1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4" style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>За връзване
                    </span>
                </div>
            </div>
            ...
            <span>50% модал</span> <br />
            <span>50% полиестер</span> <br /><br />
