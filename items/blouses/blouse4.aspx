<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blouse4.aspx.cs" Inherits="items_blouses_blouse4" %>
...
<head runat="server">
    ...
    <title>Блуза с дълбоко деколте</title>    
    <meta charset="utf-8"/>
...
<body>
    ...
    <script type="text/javascript">
        function setOpacity1() {
            ...
            document.getElementById("colorName").innerText = "Пъстро";
        } 
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content-wrapper">
		    <div class="column">
			    <img id="featured" src="/images/blouses/blouse4/blouse4_red1.jpg"/>
			    <div id="slide-wrapper" >
		            <img id="slideLeft" class="arrow" src="/images/arrow-left.png"/>
			        <div id="slider">
				        <img class="thumbnail active" id="img1" onmouseover="setActive1()" src="/images/blouses/blouse4/blouse4_red1.jpg" style="opacity:1"/>
                        <img class="thumbnail" id="img2" onmouseover="setActive2()" src="/images/blouses/blouse4/blouse4_red2.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img3" onmouseover="setActive3()" src="/images/blouses/blouse4/blouse4_red3.jpg" style="opacity:0.5"/>
				        <img class="thumbnail" id="img4" onmouseover="setActive4()" src="/images/blouses/blouse4/blouse4_red4.jpg" style="opacity:0.5"/>
                        <img class="thumbnail" id="img5" onmouseover="setActive5()" src="/images/blouses/blouse4/blouse4_red5.jpg" style="opacity:0.5"/>
			        </div>
		    ...
		    <div class="column">
			    <h1>Блуза с дълбоко деколте</h1> <br />
                <div style="background-color:#cc0000; width:70px; color:white; font-weight:bold; text-align:center">-17%</div>
			    <h4 style="display:inline-block; color:#cc0000">88,99 лв.</h4>
                <del class="oldPrice" style="color:dimgrey">73,99 лв.</del>
                <br />
                
                <!-- color chooser -->
                <div id="slide-colors" >
                    <h5 style="display: inline-block; vertical-align:baseline">Цвят:</h5>
                    <h6 style="display:inline-block" id="colorName">Пъстро</h6>
                    <br />
                    
                    <label>
                        <input type="radio" name="colorRadio" value="red" style="position: absolute; opacity:0; width:0; height:0;"/>
                        <img class="thumbnail" onmouseover="setOpacity1()" id="red" src="/images/blouses/blouse4/blouse4_red1.jpg" style ="width:80px; height:100px; opacity:1; border-color: darkgrey; border-radius: 3px;"/>                    
                    </label>
		        </div>                       
        ...
        <div class="container" id="description" style="margin-left:13%; width:31%; margin-top: 1%; display: none">
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Вискоза
                    </span>
                </div>
            ...
            <div class="row justify-content-between">
                <div class="col-4" style="width:53%;padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Туника
                    </span>
                </div>
                 <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
        ...
        <div class="row justify-content-between">
                <div class="col-4" style="width:53%;padding-bottom:1%">
                 ...
                 <div class="col-4"  style="width:47% !important; padding-bottom:1%">
                    <span>
                        <i class="fa fa-check-square" style="padding-right:3%"></i>Блузи тип риза
                    </span>
                </div>
            </div>
