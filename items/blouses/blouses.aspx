<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blouses.aspx.cs" Inherits="items_blouses_blouses" %>
                ...
                <div class="container">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/blouses/blouse2.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            <img src="/images/blouses/blouse2/blouse2_blue1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/blouses/blouse2.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Блуза тип риза</h6> 
                                        <span class="newPrice">44,99 лв.</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col">    
                            <div class="card" style="width: 18rem; position:relative">
                                <div class="text-center"> 
                                    <a href="/items/blouses/blouse3.aspx" style="color: inherit; text-decoration: none">
                                        <div class="image">
                                            ...
                                            <img src="/images/blouses/blouse3/blouse3_beige1.jpg" class="item"/> 
                                        </div>
                                    </a>
                                    <div class="wishlist">
                                        <button type="button" id="heartButton" class="btn btn-default swap" data-toggle="tooltip" data-placement="right" title="Добави в любими">
                                ...
                                <a class="productInfo" href="/items/blouses/blouse3.aspx" style="color: inherit; text-decoration: none">
                                    <div class="about text-center">
                                        <h6>Блуза с широки ръкави</h6> 
                                        <span class="newPrice">67,99 лв.</span>
                                    </div>
                                </a>
                            </div> 
                        </div>
